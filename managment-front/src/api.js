...
// Backend URL from .env (VITE_MANEGER_API_URL); default is deployed management API.
...
export const lab = {
  ...
  addExperiment: (projectId, body) => api.post(`/api/projects/${projectId}/experiments`, body).then(r => r.data),
