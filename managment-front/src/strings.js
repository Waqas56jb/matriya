...
export default {
  ...
  authLoginLead: 'התחברות עם דוא"ל וסיסמה. חשבון נוצר על ידי מנהל המערכת.',
  ...
  loginEmailLabel: 'דוא"ל',
  forgotPassword: 'שכחת סיסמה?',
  forgotTitle: 'איפוס סיסמה',
  forgotLead: 'הזן את כתובת הדוא"ל של חשבון הניהול שלך.',
  forgotContinue: 'המשך',
  forgotNoAccount: 'לא נמצא חשבון ניהול עבור דוא"ל זה.',
  forgotNewTitle: 'סיסמה חדשה',
  forgotNewLead: 'בחר סיסמה חדשה (לפחות 6 תווים).',
  forgotSubmit: 'עדכן סיסמה',
  forgotSuccess: 'הסיסמה עודכנה. אפשר להתחבר.',
  forgotBackLogin: 'חזרה להתחברות',
  forgotMismatch: 'הסיסמאות אינן תואמות.',
  forgotTokenMissing: 'פג תוקף או קישור לא תקין. התחל מחדש.',
  forgotConfirm: 'אימות סיסמה',
  forgotPwShort: 'הסיסמה חייבת להכיל לפחות 6 תווים.',
